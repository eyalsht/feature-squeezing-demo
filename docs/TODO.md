...
- [x] Task 8 — Dataset images added ([per-step plan](docs/superpowers/plans/2026-05-13-feature-squeezing-demo.md#task-8--dataset-preparation)) — `alice`, `bob`, `ron` (6 × 640×480 JPEGs); `IdentityDatabase.load()` discovers all 3 pairs ✓

Deliverables: `dataset.py`, `tests/test_dataset.py`, `dataset/{alice,bob,ron}_{1,2}.jpg`
